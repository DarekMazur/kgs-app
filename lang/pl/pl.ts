  ...
  admin: {
    ...
    user: {
      ...
      message: {
        ...
        suspendMessageHeader: 'Twoje konto zostało',
        suspendMessageHeaderBy: 'przez',
        suspendMessageConfirmationHeader: 'Konto Użytkownika',
        suspendMessageConfirmationHeaderAction: 'zostało',
        suspendedAction: 'zawieszone',
        removeSuspendedAction: 'odwieszone',
        removeSuspendedMessageHeader: 'przez',
